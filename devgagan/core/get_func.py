...
# --- Updated rename_file function ---
# This version follows your solution code logic:
# If a file has an extension that is alphabetic and 4 characters or less,
# it preserves the extension (with the special case of converting 'mov' to 'mp4').
# Otherwise, it forces the extension to "mp4".
